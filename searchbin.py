    ...
    try:
        ...
        while True:  # Begin main loop for searching through a file.
            if match == -1:  # No match.
                ...
                # TODO: JSON
                report_json.save_prediction(find_offset)
...
class report_json_class():
    def __init__(self, file):
        self.file = file
        self.data = dict()
        self.data['matches'] = list()

    def save_prediction(self, match_offset):
        # Save: filename, old_prediction, new_prediction, iterations, cpu_time, original_size, expanded_size, last_improved_iteration
        self.data['matches'].append(match_offset)
